...
import CardCreateBoard from "../../components/CardCreateBoard/CardCreateBoard";
                    ...
                    <Stack flexDirection={isPhoneScreen ? 'column' : 'row'} justifyContent={'space-between'} gap={1} paddingY={1} alignItems={isPhoneScreen ? 'flex-start' : 'center'}>
                      ...
                      <Stack flexDirection={'row'} width={isPhoneScreen ? '100%' : undefined} justifyContent={isPhoneScreen ? 'space-between' : 'flex-end'} gap={isPhoneScreen ? 0.8 : 1} height={35}>
                        <Button
                          ...
                          component={Link}
                          onClick={() => handleExpand(dat.workspace_id)} to="/home/boards" sx={{ fontSize: 12 }} variant="contained" startIcon={
                            <SpaceDashboardIcon sx={{ height: 16, width: 16 }}
                            />}>
                          Boards
                        </Button>
                        <Button
                          fullWidth={isPhoneScreen}
                          component={Link}
                          onClick={() => handleExpand(dat.workspace_id)} to="/home/members"
                        ...
                        {!isPhoneScreen &&
                          <Button
                            component={Link}
                            onClick={() => handleExpand(dat.workspace_id)} to="/home/settings" sx={{ fontSize: 12 }} variant="contained" startIcon={
                      ...
                      {isPhoneScreen &&
                        <Stack
                          component={Link}
                          onClick={() => handleExpand(dat.workspace_id)} to="/home/settings" flexDirection={'row'} justifyContent={'flex-end'} width={'100%'} height={35}>
